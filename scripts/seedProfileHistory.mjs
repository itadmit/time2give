...
// מדרגי חוות הדעת — זהויות צבאיות (חיילים, מפקדות, מפקדים, קצינים)
const REVIEWERS = [
  { phone: '+972555920001', email: 'rev01@t4g.dev', name: 'סמ"ר דניאל כהן' },
  { phone: '+972555920002', email: 'rev02@t4g.dev', name: 'רס"ן יוסי לוי' },
  { phone: '+972555920003', email: 'rev03@t4g.dev', name: 'מפקדת אוגדה 36' },
  { phone: '+972555920004', email: 'rev04@t4g.dev', name: 'סרן נועה בר' },
  { phone: '+972555920005', email: 'rev05@t4g.dev', name: 'גדוד 890 — מפקדה' },
  { phone: '+972555920006', email: 'rev06@t4g.dev', name: 'רב"ט אבי מזרחי' },
  { phone: '+972555920007', email: 'rev07@t4g.dev', name: 'מ"פ פלוגת חוד' },
  { phone: '+972555920008', email: 'rev08@t4g.dev', name: 'אל"מ רון שגב' },
  { phone: '+972555920009', email: 'rev09@t4g.dev', name: 'סמל תומר דדון' },
  { phone: '+972555920010', email: 'rev10@t4g.dev', name: 'קצינת ת"ש גדוד 51' },
  { phone: '+972555920011', email: 'rev11@t4g.dev', name: 'יחידת מילואים 8104' },
  { phone: '+972555920012', email: 'rev12@t4g.dev', name: 'מפקד מוצב — עוטף' },
];
